...
export function createMetalMaterial(opts) {
...
export function createDarkMetalMaterial(opts) {
    return new THREE.MeshStandardMaterial({
        color: 0x172431,
        metalness: 0.55,
        roughness: 0.5,
...
export function createAccentMaterial(opts) {
    return new THREE.MeshStandardMaterial({
        color: 0x2a4f6a,
        metalness: 0.6,
        roughness: 0.35,
...
export function createPolishedMaterial(opts) {
    return new THREE.MeshStandardMaterial({
        color: 0x9aa7b4,
        metalness: 0.85,
        roughness: 0.15,
...
export function createGuardMaterial(opts) {
...
export function createRubberMaterial(opts) {
    return new THREE.MeshStandardMaterial({
        color: 0x1a2d3c,
        metalness: 0.1,
        roughness: 0.85,
...
export function createCopperMaterial(opts) {
    return new THREE.MeshStandardMaterial({
        color: 0xbf7534,
        metalness: 0.45,
        roughness: 0.4,
...
export function applyFaultMaterial(mesh, faultKey, intensity = 0.5) {
